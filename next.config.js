...
module.exports = withImages({
  publicRuntimeConfig: {
    ...
    MICROSOFT_OUTLOOK_CLIENT_ID: process.env.MICROSOFT_OUTLOOK_CLIENT_ID,
    MICROSOFT_OUTLOOK_AUTHORITY: process.env.MICROSOFT_OUTLOOK_AUTHORITY,
    MICROSOFT_OUTLOOK_REDIRECT_URI: process.env.MICROSOFT_OUTLOOK_REDIRECT_URI,
